...
<div class="card bg-base-100 border">
    <div class="card-body">
        <form action="<?= base_url('dashboard/master_fakultas/create') ?>" method="post">
            <div class="grid grid-cols-12 grid-flow-row gap-4">
                <div class="col-span-12 sm:col-span-6 md:col-span-4">
                    ...
                    <input type="text" name="kode_fakultas" id="kode_fakultas" class="input input-bordered w-full" value="<?= old('kode_fakultas') ?>" />
                </div>
                <div class="col-span-12 sm:col-span-6 md:col-span-4">
